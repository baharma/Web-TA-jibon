...
function updateDataDivace2(data) {
    const cardTitleElement = document.getElementById('card-title-divace-sacond');
    const cardTextElement = document.getElementById('card-text-divace-sacond');
    const cardText1Small = document.getElementById('card-text-sacond-small');
    const cardTextTStatus = document.getElementById('status-level-divace-sacond');
    ...
    const cardImageElement = document.getElementById('image-divace2');
