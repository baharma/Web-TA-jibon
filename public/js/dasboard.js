...
function updateDataDivace1(data) {
    const cardTitleElement = document.getElementById('card-title-divace-1');
    const cardTextElement = document.getElementById('card-text-divace-1');
    const cardText1Small = document.getElementById('card-text-1-small');
    const cardTextTStatus = document.getElementById('status-level-divace-1');
    ...
    const cardImageElement = document.getElementById('image-divace1');
